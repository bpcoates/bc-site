...
import {FaBars, FaTimes, FaGithub, FaLinkedin, FaTwitterSquare, FaFacebookSquare, FaGithubSquare, FaRegCopyright} from 'react-icons/fa'
...
const Header = () => {
  ...
  return (
    <div className='fixed w-full h-[50px] flex justify-between items-center px-4 bg-[#1a363d] text-slate-400'>
        ...
        <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#1a363d] flex flex-col justify-center items-center'}>
        ...
        <ul>
            <li className='w-[100px] h-[30] flex rounded-t-sm justify-between items-center ml-[-75px] hover:ml-[0px] duration-300 hover: bg-[#1a363d] p-1 pl-5'>
                <a className='flex justify-between items-center w-full' href='https://www.linkedin.com/in/brentcoates/'>
            ...
            <li className='w-[100px] h-[30] flex rounded-b-sm justify-between items-center ml-[-75px] hover:ml-[0px] duration-300 hover: bg-[#1a363d] p-1 pl-5'>
                <a className='flex justify-between items-center w-full' href='mailto:bpcoates@hotmail.com'>
        ...
        <div className='flex fixed flex-col bottom-1 left-1 text-xs'>
            <div>
                <p className='flex pl-1 items-center tracking-widest bottom-0'>copyright&nbsp; <FaCopyright size={10} />&nbsp;2022, brent coates</p>
            </div>
        </div>
